...
QList<ACLRole::Permission> CommandExtension::getPermissions(QList<ACLRole::Permission> f_defaultPermissions) const
{
  return m_permissions.isEmpty() ? f_defaultPermissions : m_permissions;
}

QList<ACLRole::Permission> CommandExtension::getPermissions() const
{
  return getPermissions(QList<ACLRole::Permission>{});
}

void CommandExtension::setPermissions(QList<ACLRole::Permission> f_permissions)
{

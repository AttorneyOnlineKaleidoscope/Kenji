...
public:
   ...
   */
  MusicManager(Server *server, QStringList f_cdns, MusicList f_root_list, QStringList f_root_ordered, QObject *parent = nullptr);
...
public Q_SLOTS:
   ...
   *
   * @param music FM packet with the full musiclist, when enabled, and eventual custom list.
   *
   * @param f_area_index Index of the current area the edit is made in.
   */
  void sendAreaFMPacket(int f_area_index);
